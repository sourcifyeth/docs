...
- [Verify from Etherscan](/docs/api/server/v1/verify-from-etherscan) : `POST /verify-from-etherscan-legacy`

### Verification API (v2 - session based)

import V2Note from './Server/Verification (v2)/_v2Note.mdx'
...
- [Verify from Etherscan](/docs/api/server/v2/verify-from-etherscan) : `POST /verify-from-etherscan`
