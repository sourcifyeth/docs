...
- The salt can be a hex string starting with `0x` or a decimal number in string format. The value will be padded to 32 bytes before being used in the `CREATE2` opcode.
