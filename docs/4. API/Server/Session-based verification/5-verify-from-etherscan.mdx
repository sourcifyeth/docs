...
slug: /api/server/session/verify-from-etherscan
---
...
**URL** : `/session/verify-from-etherscan`
...
:::caution
`/session/verify-from-etherscan` triggers a server side request to Etherscan API, this could cause reaching the Etherscan API Limit Rate.
:::
