...
2. Input the contract address you want to verify. If a contract at that address is verified in any of the networks it will be shown above.
3. Select the network the contract is deployed to.
4. Click "Verify".
