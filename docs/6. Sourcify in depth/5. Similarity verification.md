...
On monitored chains, Sourcify's monitor also schedules delayed similarity verification jobs after contract creation events. This is especially useful for contracts that cannot be metadata-verified (for example Vyper contracts).
