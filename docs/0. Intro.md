...
We believe the current smart contract verification ecosystem has plateaued due to several key problems:
...
Our complete stack is open-source and we daily share our whole dataset in modern data formats (see [Contract dataset](/docs/repository/)).
