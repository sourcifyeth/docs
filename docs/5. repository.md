...
The contract repository is peridically updated and pinned to the IPFS. Shout out to [web3.storage](https://web3.storage/), [estuary.tech](https://estuary.tech/) for providing pinning for our public repository and also [@wmitsuda](https://twitter.com/wmitsuda) for the troubleshooting and pinning of our repo!
